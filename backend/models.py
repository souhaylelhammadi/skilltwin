...
from sqlalchemy import String, Boolean, DateTime, ForeignKey, Enum, Integer, Float, JSON
...
class JobPosting(Base):
    ...
    description_snippet: Mapped[str] = mapped_column(String(1000), nullable=True)
